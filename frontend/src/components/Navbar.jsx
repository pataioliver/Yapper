...
const Navbar = () => {
  ...
  <MessageSquare className="w-5 h-5 text-secondary-content" strokeWidth={2.5} />
        ...
        <nav className="hidden sm:flex items-center gap-2">
          <Link
            to="/settings"
            className="btn btn-sm bg-primary/10 border border-primary/20 text-primary-content gap-2 hover:bg-primary/20 hover:scale-105 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 ease-out animate-subtleScale rounded-xl"
          >
          ...
          {authUser && (
            <>
              ...
              <button
                onClick={logout}
                className="btn btn-sm bg-secondary/10 border border-secondary/20 text-secondary-content gap-2 hover:bg-secondary/20 hover:scale-105 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 ease-out animate-subtleScale rounded-xl"
              >
        ...
        <div className="sm:hidden">
          <button
            onClick={toggleMenu}
            className="btn btn-sm bg-tertiary/10 border border-tertiary/20 text-tertiary-content hover:bg-tertiary/20 hover:scale-105 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 ease-out animate-subtleScale rounded-xl"
          ...
          <nav className="sm:hidden absolute top-16 left-0 w-full bg-base-100/85 backdrop-blur-2xl border-b border-quaternary/20 shadow-[0_0_20px_rgba(255,255,255,0.1)] animate-slideDown">
            <div className="flex flex-col items-center gap-2 py-4">
              <Link
                to="/settings"
                onClick={toggleMenu}
                className="btn btn-sm bg-primary/10 border border-primary/20 text-primary-content w-full max-w-xs gap-2 hover:bg-primary/20 hover:scale-105 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 ease-out animate-subtleScale rounded-xl"
              >
                <Settings className="size-4 text-primary-content" />
                Settings
              </Link>
              {authUser && (
                <>
                  ...
                  <button
                    ...
                    className="btn btn-sm bg-secondary/10 border border-secondary/20 text-secondary-content w-full max-w-xs gap-2 hover:bg-secondary/20 hover:scale-105 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] transition-all duration-300 ease-out animate-subtleScale rounded-xl"
                  >
                    <LogOut className="size-4 text-secondary-content" />
                    Logout
                  </button>
