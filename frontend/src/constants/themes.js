...
export const THEME_COLORS = {
  ...
  cmykDark: {
    ...
    font: "Inter, sans-serif",
    "primary-content": "#e6e7e6",
    "secondary-content": "#ffffff",
    "tertiary-content": "#ffffff",
    "quaternary-content": "#e6e7e6",
    "base-100": "#2a2a2a",
    "base-200": "#3f3f3f",
    "base-300": "#555555",
    "base-content": "#e6e7e6",
  ...
  asiimov: {
    primary: "#f5f6f5", // White base inspired by Asiimov
    secondary: "#ff6f00", // Vibrant orange
    tertiary: "#1a1a1a", // Black accents
    quaternary: "#b0b0b0", // Light gray for subtle highlights
    theme_color: "#ff6f00",
    background_color: "#f5f6f5",
